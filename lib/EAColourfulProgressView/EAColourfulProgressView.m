...
- (void)setupView
{
    ...
    _initialFillColor = [UIColor greenColor];
    _oneThirdFillColor = [UIColor colorWithRed:0.800 green:0.800 blue:0.000 alpha:1];
    _twoThirdsFillColor = [UIColor colorWithRed:0.800 green:0.400 blue:0.000 alpha:1];
    _finalFillColor = [UIColor redColor];
    
    //self.containerColor = [UIColor colorWithRed:0.200 green:0.459 blue:0.298 alpha:1];
    //self.labelTextColor = [UIColor colorWithRed:0.467 green:0.176 blue:0.208 alpha:1];
